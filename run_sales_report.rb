...
grouped_transaction_data = SalesReport.group_transaction_data(transaction_data, shops_by_id)

SalesReport.write_csv(grouped_store_data,SalesReport::SHOP_HEADERS, "store_summary.csv")
SalesReport.write_csv(grouped_transaction_data,SalesReport::TRANSACTION_HEADERS, "transaction_breakdown.csv")